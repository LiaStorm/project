...
pars_oblasti = pd.read_csv(r"https://github.com/LiaStorm/project/blob/8025e6ac73a5a8db4fcc213079d9f52eced676cf/pars_oblasti_RF_clean_true.csv",engine='python', sep=',', on_bad_lines='skip')
