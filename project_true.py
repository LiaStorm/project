...
map_count_prof = html.Div(children=[
        html.Iframe(id='map2', srcDoc=open("CountRoles.html", 'r').read(), width = "100%", height = "600")
], style={'padding': 10, 'flex': 1})
map_oblas_prof = html.Div(children=[
        html.Iframe(id='map3', srcDoc=open("OblastiRoles.html", 'r').read(), width = "100%", height = "600")
], style={'padding': 10, 'flex': 1})
map_prof = html.Div(children=[
        html.Iframe(id='map4', srcDoc=open("Roles.html", 'r').read(), width = "100%", height = "600")
], style={'padding': 10, 'flex': 1})
